...
small relative-age column in the existing one-line compact layout.`,comments:0,createdAt:`2026-09-10T10:37:40Z`,labels:[`enhancement`],number:6010,repo:`jesseduffield/lazygit`,title:`Show relative commit age in the compact commits view`,url:`https://github.com/jesseduffield/lazygit/issues/6010`,reactions:0,policy:{level:1,rule:null,source:null,verified:!1,label:`grey`},participants:1,repoStars:82627,repoSizeKb:157821,merges90d:40,medianMergeDays:0,outsiderPct:0,issueResponsePct:62,score:{value:3,band:`low`,classe:{n:1,why:[`labelled 'enhancement', not a defect`]},alcance:{n:1,why:[`narrow platform/config: 'only when'`]},verificabilidade:{n:1,why:[`no reproduction in the report`]},effort:{n:3,why:[`sounds localised: 'one-line'`]},acceptance:{n:3,why:[`40 merges in 90d`,`median merge 0d`,`62% of recent issues got a maintainer reply`]},notes:[],estimated:!0}}]},l=t(),u=c.issues,d=c.generated,f={1:`comment`,2:`string`,3:`keyword`,4:`number`};function p({n:e,label:t,color:n}){let{theme:i}=r();return(0,l.jsxs)(`span`,{className:`inline-flex items-center gap-1.5`,title:t,children:[(0,l.jsx)(`span`,{className:`text-[11px] font-mono`,style:{color:i.comment},children:t}),(0,l.jsx)(`span`,{className:`inline-flex gap-0.5`,children:[1,2,3].map(t=>(0,l.jsx)(`span`,{className:`w-1.5 h-3 rounded-sm`,style:{backgroundColor:t<=e?n:i.bg1}},t))})]})}function m({issue:e}){let{theme:t}=r(),[n,i]=(0,o.useState)(!1),a=e.score,s=t[f[e.policy.level]];return(0,l.jsxs)(`li`,{className:`rounded-lg p-5`,style:{backgroundColor:t.bg,border:`1px solid ${t.bg1}`},children:[(0,l.jsxs)(`div`,{className:`flex items-baseline justify-between gap-4 flex-wrap`,children:[(0,l.jsxs)(`a`,{href:e.url,target:`_blank`,rel:`noopener noreferrer`,className:`font-mono text-sm transition-opacity hover:opacity-70`,style:{color:t.function},children:[e.repo,`#`,e.number]}),(0,l.jsxs)(`span`,{className:`text-xs font-mono`,style:{color:t.comment},children:[e.repoStars.toLocaleString(),` stars`]})]}),(0,l.jsx)(`h3`,{className:`text-base mt-1 mb-4 font-sans`,style:{color:t.fg},children:e.title}),(0,l.jsxs)(`div`,{className:`flex flex-wrap items-center gap-x-5 gap-y-2 mb-3`,children:[(0,l.jsxs)(`span`,{className:`text-xs font-mono px-2 py-0.5 rounded`,style:{color:a.band===`high`?t.bg:t.fg,backgroundColor:a.band===`high`?t.accent:t.bg1},children:[`value `,a.value]}),(0,l.jsx)(p,{n:a.classe.n,label:`class`,color:t.accent}),(0,l.jsx)(p,{n:a.alcance.n,label:`reach`,color:t.accent}),(0,l.jsx)(p,{n:a.verificabilidade.n,label:`repro`,color:t.accent}),(0,l.jsx)(p,{n:a.effort.n,label:`effort`,color:t.function}),(0,l.jsx)(p,{n:a.acceptance.n,label:`accept`,color:t.function})]}),(0,l.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3 text-xs`,children:[(0,l.jsxs)(`span`,{className:`font-mono`,style:{color:s},children:[`AI policy: `,e.policy.label,e.policy.verified?``:` (unread)`]}),(0,l.jsx)(`button`,{onClick:()=>i(!n),className:`font-mono underline underline-offset-2 transition-opacity hover:opacity-70`,style:{color:t.comment},children:n?`hide`:`why`})]}),a.notes.map(e=>(0,l.jsxs)(`p`,{className:`text-xs mt-3 font-mono`,style:{color:t.number},children:[`! `,e]},e)),n&&(0,l.jsxs)(`dl`,{className:`mt-4 pt-4 grid sm:grid-cols-2 gap-x-6 gap-y-2 text-xs`,style:{borderTop:`1px solid ${t.bg1}`},children:[[[`class`,a.classe],[`reach`,a.alcance],[`repro`,a.verificabilidade],[`effort`,a.effort],[`acceptance`,a.acceptance]].map(([e,n])=>(0,l.jsxs)(`div`,{children:[(0,l.jsxs)(`dt`,{className:`font-mono`,style:{color:t.comment},children:[e,` `,n.n]}),(0,l.jsx)(`dd`,{style:{color:t.operator},children:n.why.join(` · `)||`—`})]},e)),e.policy.rule&&(0,l.jsxs)(`div`,{className:`sm:col-span-2`,children:[(0,l.jsxs)(`dt`,{className:`font-mono`,style:{color:t.comment},children:[`policy (`,e.policy.source,`)`]}),(0,l.jsx)(`dd`,{style:{color:t.operator},children:e.policy.rule})]})]})]})}function h(){let{theme:e}=r(),[t,n]=(0,o.useState)(``),[i,a]=(0,o.useState)(4),s=(0,o.useMemo)(()=>{let e=t.trim().toLowerCase();return u.filter(t=>t.policy.level>i?!1:e?t.repo.toLowerCase().includes(e)||t.title.toLowerCase().includes(e)||t.labels.some(t=>t.toLowerCase().includes(e)):!0)},[t,i]);return(0,l.jsxs)(`div`,{className:`w-full max-w-4xl mx-auto px-4 py-20`,children:[(0,l.jsx)(`a`,{href:`/`,className:`inline-block text-xs font-mono mb-6 transition-opacity hover:opacity-70`,style:{color:e.comment},children:`← Harbefas`}),(0,l.jsx)(`p`,{className:`text-xs font-mono tracking-widest uppercase mb-4`,style:{color:e.accent},children:`Find something to fix`}),(0,l.jsx)(`h1`,{className:`text-3xl sm:text-4xl font-bold mb-4`,style:{color:e.fg},children:`Issues worth your weekend`}),(0,l.jsxs)(`p`,{className:`max-w-2xl text-base leading-relaxed mb-3`,style:{color:e.operator},children:[`Every aggregator shows you the `,(0,l.jsx)(`code`,{className:`font-mono text-sm`,children:`good first issue`}),` `,`label. The label lies: someone already has a branch, or the maintainer has not merged anything since 2024, or the project forbids the way you work. Everything below survived those three checks, then got scored on what the fix is worth.`]}),(0,l.jsxs)(`p`,{className:`max-w-2xl text-sm leading-relaxed mb-10`,style:{color:e.comment},children:[`The scores are estimates from labels and text — press `,(0,l.jsx)(`em`,{children:`why`}),` on any card to see the evidence behind each one. Projects that prohibit AI-assisted contribution are labelled, never hidden: contributing by hand is fine, and then the rule is just something to cite.`]}),(0,l.jsxs)(`div`,{className:`flex flex-wrap gap-3 items-center mb-8`,children:[(0,l.jsx)(`input`,{value:t,onChange:e=>n(e.target.value),placeholder:`filter by repo, title or label`,className:`flex-1 min-w-[220px] px-3 py-2 rounded-lg text-sm font-mono outline-none`,style:{backgroundColor:e.bg,border:`1px solid ${e.bg1}`,color:e.fg}}),(0,l.jsx)(`div`,{className:`flex gap-1`,children:[{level:1,label:`grey only`},{level:3,label:`no prohibits`},{level:4,label:`everything`}].map(t=>(0,l.jsx)(`button`,{onClick:()=>a(t.level),className:`px-3 py-2 rounded-lg text-xs font-mono transition-colors`,style:{backgroundColor:i===t.level?e.accent:`transparent`,color:i===t.level?e.bg:e.comment,border:`1px solid ${i===t.level?e.accent:e.bg1}`},children:t.label},t.level))})]}),(0,l.jsx)(`ul`,{className:`flex flex-col gap-4`,children:s.map(e=>(0,l.jsx)(m,{issue:e},`${e.repo}#${e.number}`))}),s.length===0&&(0,l.jsx)(`p`,{className:`text-sm`,style:{color:e.comment},children:`Nothing matches that filter.`}),(0,l.jsxs)(`p`,{className:`text-xs font-mono mt-10`,style:{color:e.comment},children:[s.length,` of `,u.length,` · last run `,d.slice(0,10),` ·`,` `,(0,l.jsx)(`a`,{href:`https://github.com/harbefas`,className:`underline underline-offset-2`,children:`built with oss-triage`})]})]})}(0,s.createRoot)(document.getElementById(`root`)).render((0,l.jsx)(o.StrictMode,{children:(0,l.jsxs)(n,{children:[(0,l.jsx)(h,{}),(0,l.jsx)(a,{})]})}));